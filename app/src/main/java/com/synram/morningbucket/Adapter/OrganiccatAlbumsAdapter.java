...
public class OrganiccatAlbumsAdapter extends RecyclerView.Adapter<OrganiccatAlbumsAdapter.MyViewHolder> {


    private Context mContext;
    private List<OrganicCatRespo> albumList;
...
//            overflow = (ImageView) view.findViewById(R.id.overflow);
    ...
    public OrganiccatAlbumsAdapter(Context mContext, List<OrganicCatRespo> albumList) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        OrganicCatRespo subCatview = albumList.get(position);
